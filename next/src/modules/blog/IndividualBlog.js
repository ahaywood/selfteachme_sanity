      ...
      <div className={`content-grid move-content-up ${titleWithinHero ? '' : 'no-title'}`}>
        ...
        <div className="bg-white z-20 col-start-2">
          ...
          <div className="px-8 pt-8">
            ...
            {postDetails.dateUpdated ?
              (<h3 className="uppercase text-baliHai font-condensed tracking-wider text-2xl text-center mb-12">Last Updated: {prettyDate(postDetails.dateUpdated)}</h3>)
              :
              (<h3 className="uppercase text-baliHai font-condensed tracking-wider text-2xl text-center mb-12">Published: {prettyDate(postDetails.datePublished)}</h3>)
            }
          </div>
        </div>
      </div>
