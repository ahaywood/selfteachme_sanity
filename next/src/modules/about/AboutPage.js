...
const AboutPage = () => {
  ...
  return (
    <div className="content-grid move-content-up">
      ...
      <div className="bg-white z-20 col-span-3 md:col-span-2 flex flex-col md:flex-row sm:mb-8">
        <div className="px-4 pt-4 sm:px-8 sm:pt-8 flex-1">
          <h2 className="font-condensed uppercase text-4xl sm:text-7xl leading-stacked mb-8">I will teach you how to code</h2>
          <h2 className="font-handwriting text-6xl sm:text-8xl relative sm:-ml-10 my-8">Let's be Honest</h2>
      ...
      <div className="col-span-3 sm:col-span-1 sm:col-start-2 px-4 sm:px-8">
      ...
      <div className="col-start-1 sm:col-start-2 col-span-3 sm:col-span-1 px-4 sm:px-8 mt-4">
        <h2 className="font-handwriting text-6xl sm:text-8xl relative sm:-ml-10 my-8">Learn to Code & Level Up</h2>
        <h3 className="font-condensed text-baliHai uppercase text-3xl sm:text-6xl leading-stacked">...in a way that makes sense to you.</h3>
      ...
      <div className="col-span-3 text-center font-modern italic font-bold text-3xl sm:text-4xl bg-callout bg-cover py-12 mt-8 mb-16 sm:mb-24 px-4 sm:px-0">
      ...
      <div className="col-span-3 w-full grid grid-cols-12">
        <div className="col-start-2 col-span-8 pb-8">
      ...
      <div className="col-span-3 grid grid-cols-12">
        <div className="col-start-1 col-span-12 sm:col-span-6 row-start-1 row-span-1">
          <img src="/img/about__why-should-i-care-1.jpg" alt="You've Got This" />
        </div>
        <div className="col-start-1 col-span-12 sm:col-span-6 row-start-3 sm:row-start-2 row-span-1">
          <img src="/img/about__why-should-i-care-2.jpg" alt="" className="hidden sm:block" />
          <div className="bg-brightPink p-8">
            <p className="font-sans text-white mb-0 sm:max-w-2/3">All these experiences, can help me translate where you are to where you want to be and determine the best way to get there.</p>
          </div>
        </div>
        <div className="why-should-i-care col-span-12 sm:col-span-6 col-start-1 sm:col-start-5 sm:row-start-1 sm:row-span-2 bg-white px-4 sm:px-16 pt-14 pb-8 sm:py-14 sm:mt-32">
      ...
      <div className="col-span-3 grid grid-cols-12 sm:pb-8">
        <div className="col-span-12 md:col-span-5">
          <img src="/img/about__dutton-family.jpg" srcSet="/img/about__dutton-family.jpg 1x, /img/about__dutton-family@2x.jpg 2x" alt="Dutton Family" />
        </div>
        <div className="col-span-12 md:col-span-6 px-4 md:pl-8 md:pr-0 pt-8 md:pt-16">
          <h2 className="font-condensed uppercase text-6xl sm:text-8xl leading-stacked">Say Hello <span className="font-handwriting lowercase">and</span> Introduce Yourself</h2>
      ...
      <div className="col-start-1 sm:col-start-2 col-span-3 sm:col-span-1 px-4 sm:px-0">
      ...
      <div className="col-span-3 max-w-4xl mx-auto mt-8 mb-10">
        <h2 className="font-condensed uppercase leading-stacked text-5xl sm:text-6xl px-4 sm:px-0">With 20 years of experience, I’ve built hundreds of websites. I can teach you.</h2>
      </div>
      {/* logos */}
      ...
      <div className="col-span-3 grid grid-cols-12 mb-8">
        <div className="col-start-1 sm:col-start-2 col-span-12 sm:col-span-6 sm:mr-8 px-4 sm:px-0">
      ...
      <div className="col-start-1 sm:col-start-2 col-span-3 sm:col-span-1 my-8 px-4 sm:px-0">
      ...
      <div className="col-span-3 grid grid-cols-12 mb-8">
        <div className="col-start-1 sm:col-start-2 col-span-12 sm:col-span-6 pt-0 sm:pt-8 px-4 sm:px-0">
        ...
        <div className="row-span-1 sm:row-span-2 col-start-1 sm:col-start-9 col-span-12 sm:col-span-4 px-4 sm:px-8 flex flex-row sm:flex-col">
          <div className="flex-1 mr-2 sm:mr-0 relative top-8 sm:top-0">
            <img className="mb-16 w-full" src="/img/about__screenshot__rorke-denver.jpg" alt="Screenshot of Rorke Denver's Website" />
          </div>
          <div className="flex-1 ml-2 sm:ml-2">
            <img className="w-full" src="/img/about__screenshot__ginger-hardage.jpg" alt="Screenshot of Ginger Hardage's Website" />
          </div>
        </div>
        <div className="col-span-6 sm:col-span-4 sm:mr-4 px-4 sm:px-8 relative -top-12 sm:top-0">
          <img className="w-full" src="/img/about__screenshot__ylm.jpg" alt="Screenshot of Yellow Leaf Marketing's Website" />
        </div>
        <div className="col-span-6 sm:col-span-4 pl-2 pr-4 sm:px-8 sm:pt-16 relative top-8 sm:top-0">
      ...
      <div className="col-span-3 grid grid-cols-12 mb-10 sm:mb-16">
        <div className="col-start-1 sm:col-start-2 row-start-2 sm:row-start-1 col-span-12 sm:col-span-7 sm:pt-16 px-4 sm:px-8">
          <img src="/img/about__zeal-team.jpg" alt="Coding Zeal Team" />
        </div>
        <div className="col-span-12 sm:col-span-3 px-4 sm:px-8">
          <img className="float-right sm:float-none mb-8 max-w-48" src="/img/about__zeal-logo-large.png" srcSet="/img/about__zeal-logo-large.png 1x, /img/about__zeal-logo-large@2x.png 2x" alt="Coding ZEAL logo" />
