...
const AboutPage = () => {
  ...
  return (
    <div className="content-grid move-content-up">
      <Hero title="About" src="/img/bg__about.jpg" />;
      <div className="bg-white z-20 col-span-2 flex mb-8">
        <div className="px-8 pt-8 flex-1">
          <h2 className="font-condensed uppercase text-7xl leading-stacked mb-8">I will teach you how to code</h2>
          <h2 className="font-handwriting text-8xl relative -ml-10 my-8">Let's be Honest</h2>
      ...
      <div className="col-start-2 px-8 mt-4">
        <h2 className="font-handwriting text-8xl relative -ml-10 my-8">Learn to Code & Level Up</h2>
        <h3 className="font-condensed text-baliHai uppercase text-6xl">...in a way that makes sense to you.</h3>
        ...
        <h3 className="font-condensed uppercase text-6xl text-bunting leading-stacked pt-8">I've been in  your place.</h3>
        <h3 className="font-condensed uppercase text-6xl text-baliHai leading-stacked pb-8">It looks like magic.</h3>
      ...
      <div className="col-span-3 text-center font-modern italic font-bold text-4xl bg-callout bg-cover py-12 mt-8 mb-24">
      ...
      <div className="col-span-3 w-full grid grid-cols-12">
        <div className="col-start-2 col-span-8 pb-8">
          <h3 className="font-condensed uppercase text-bunting text-6xl">I truly believe:</h3>
      ...
      <div className="col-span-3 grid grid-cols-12">
        <div className="col-start-1 col-span-6 row-start-1 row-span-1">
          <img src="/img/about__why-should-i-care-1.jpg" alt="" />
        </div>
        <div className="col-start-1 col-span-6 row-start-2 row-span-1">
          <img src="/img/about__why-should-i-care-2.jpg" alt="" />
          <div className="bg-brightPink p-8">
            <p className="font-sans text-white mb-0 max-w-2/3">All these experiences, can help me translate where you are to where you want to be and determine the best way to get there.</p>
          </div>
        </div>
        <div className="why-should-i-care col-span-6 col-start-5 row-start-1 row-span-2 bg-white px-16 py-14 mt-32">
          <hr className="border-none bg-hrShort h-9 bg-no-repeat relative -left-6 mb-4" />
          <h3 className="uppercase font-condensed text-6xl leading-stacked mb-2">WHY SHOULD I CARE ABOUT READING YOUR WEBSITE?</h3>
          <h4 className="text-baliHai font-condensed text-4xl mb-4">I write from a wide variety of experiences. </h4>
          ...
          <img src="/img/about__ufl.png" srcSet="/img/about__ufl.png 1x, /img/about__ufl@2x.png 2x" alt="University of Florida" className="float-right ml-8" />
      ...
      <div className="col-span-3 grid grid-cols-12 pb-8">
        ...
        <div className="col-span-6 pl-8 pt-16">
          <h2 className="font-condensed uppercase text-8xl leading-stacked">Say Hello <span className="font-handwriting lowercase">and</span> Introduce Yourself</h2>
      ...
      <div className="col-span-3 max-w-4xl mx-auto mt-8 mb-10">
        <h2 className="font-condensed uppercase leading-stacked text-6xl">With 20 years of experience, I’ve built hundreds of websites. I can teach you.</h2>
      </div>
      {/* logos */}
      <div className="col-span-3 mb-28 mx-auto max-w-7xl">
        <LogoGrid />
      </div>
      <div className="col-span-3 grid grid-cols-12 mb-8">
        <div className="col-start-2 col-span-6 mr-8">
          <h2 className="uppercase font-condensed leading-stacked text-8xl mb-4">The Main Story</h2>
      ...
      <div className="col-span-3 max-w-4xl mx-auto my-8 flex">
        <div className="mr-8">
      ...
      <div className="col-span-3 grid grid-cols-12 mb-8">
        ...
        <div className="row-span-2 col-start-9 col-span-4 px-8">
        ...
        <div className="col-span-4 px-8 pt-16">
      ...
      <div className="col-span-3 grid grid-cols-12 mb-16">
        <div className="col-start-2 col-span-7 pt-16 px-8">
          <img src="/img/about__zeal-team.jpg" alt="Coding Zeal Team" />
        </div>
        <div className="col-span-3 px-8">
          <img className="mb-8" src="/img/about__zeal-logo-large.png" srcSet="/img/about__zeal-logo-large.png 1x, /img/about__zeal-logo-large@2x.png 2x" alt="Coding ZEAL logo" />
