...
const Nav = ({ className }: Props): JSX.Element => (
  <div className={`bg-gold font-condensed uppercase text-2xl font-normal ${className}`}>
    <ul className="list-none flex flex-col md:flex-row justify-center items-center">
      ...
      <li className="footer-nav-item">
        <a href="http://compressed.fm" target="_blank" className="h-6 hover:text-sapphire" rel="noreferrer">
          Podcast
        </a>
      </li>
      <li className="mb-0 hidden md:block">
      ...
      <li className="footer-nav-item">
        <a href="https://selfteachme.circle.so/" target="_blank" className="h-6 hover:text-sapphire" rel="noreferrer">
          Community
        </a>
      </li>
      <li className="mb-0 hidden md:block">
