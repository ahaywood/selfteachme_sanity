...
const Social = ({ className, social, ...props }) => (
  <ul className={`text-white flex flex-wrap md:flex-nowrap justify-center list-none ${className}`}>
    ...
    {social?.pinterest && (
      <li className="px-3">
        <a href={social.pinterest} target="_blank" className="hover:text-gold">
          <Icon name="pinterest" />
        </a>
      </li>
    )}
    ...
    {social?.instagram && (
      <li className="px-3">
        <a href={social.instagram} target="_blank" className="hover:text-gold">
          <Icon name="instagram" />
        </a>
      </li>
    )}
    ...
    {social?.soundcloud && (
      <li className="px-3">
        <a href={social.soundcloud} target="_blank" className="hover:text-gold">
