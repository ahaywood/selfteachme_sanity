...
* COMPONENT
---------------------------------------------------- */
const Search = ({ isSearchOpen, toggleSearch }: Props): JSX.Element => {
  ...
  return (
    ...
    >
      <div className="text-center w-full absolute left-0 top-8">
        <button onClick={toggleSearch} className="focus:outline-none" type="button">
      ...
      >
        ...
        <div className="flex justify-center w-full">
          ...
          />
          <button className="text-white hover:text-gold" type="submit">
            <Icon name="arrow" />
          </button>
        </div>
      </form>
