    ...
    >
      ...
      <div className="ml-4 flex-1">
        <label htmlFor="keywords">
          Search <span className="hidden md:inline">(using keywords and English)</span>
        </label>
        <input
          type="text"
          name="keywords"
      ...
      <div className="ml-auto">
        <button
          className="bg-peach hover:bg-white relative rounded-lg block sm:top-7 w-72 sm:w-48 h-14 sm:ml-6"
          role="submit"
        >
