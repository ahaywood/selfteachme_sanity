...
* COMPONENT
---------------------------------------------------- */
const FourOFourPage = ({ latestPosts }: Props): JSX.Element => (
  <>
    <div className="content-grid move-content-up">
      <Hero title="404" src="/img/bg__contact.jpg" className="hero" subtitle="" />
      <div className="main px-8 pt-8 sm:pt-0 md:px-12 md:pt-12 flex flex-col sm:flow-row">
        ...
        <div className="sm:ml-8">
          ...
          <p>
            Don’t worry about it.You can either go to the{' '}
            <Link href="/">
              <a>homepage</a>
            </Link>{' '}
            or stay here and watch a funny YouTube video.
          </p>
        </div>
      </div>
      ...
      <div className="col-start-2 px-8 py-12">
        ...
        <h4 className="uppercase font-condensed text-baliHai text-2xl tracking-wide">
          Maybe these links will help you find what you’re really looking for
        </h4>
      </div>
      {/* search bar */}
